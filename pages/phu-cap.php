                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="allowanceCode" value="<?php echo $allowanceCode; ?>" readonly>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên phụ cấp" name="titleAllowance">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Tiền phụ cấp: </label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tiền phụ cấp" name="allowanceAmount">
                      </div>
                      <div class="form-group">
