...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(empty($overtimeHours) || !is_numeric($overtimeHours))
    ...
    if(!$error)
    {
      ...
      echo '<script>setTimeout("window.location=\'cham-cong.php?p=staff&a=attendance\'",2000);</script>';
    }
  }
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="attendanceCode" value="<?php echo $row['ma_cham_cong']; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Số ngày công: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập số ngày công" value="<?php echo $row['so_ngay_cong']; ?>" name="workingDays">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Số giờ làm thêm: </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập số giờ làm thêm" value="<?php echo $row['so_gio_lam_them']; ?>" name="overtimeHours">
                    </div>
                    <div class="form-group">
