...
?>
	...
	<div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <h1>
	        Tổng quan
	        <small>Phần mềm | QUẢN LÝ NHÂN SỰ CÔNG TY TNHH TMDV XNK TS QUÂN PHÁT				</small>
	      </h1>
	      <ol class="breadcrumb">
	      ...
	      <div class="row">
	        ...
	        <div class="col-lg-3 col-xs-6">
	          ...
	          <div class="small-box bg-green">
	            ...
	            <a href="export-nhan-vien.php" class="small-box-footer">Danh sách nhân viên eeeee<i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        <div class="col-lg-3 col-xs-6">
