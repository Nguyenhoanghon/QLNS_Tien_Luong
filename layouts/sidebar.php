      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($p == 'staff') echo 'active'; ?> treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if(($p == 'staff') && ($a == 'phucap')) echo 'active'; ?>"><a href="phu-cap.php?p=staff&a=phucap"><i class="fa fa-circle-o"></i> Phụ cấp</a></li>
        ...
        <li class="<?php if($p == 'salary') echo 'active'; ?> treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if(($p == 'salary') && ($a =='thuongphat')) echo 'active'; ?>"><a href="thuong-phat.php?p=salary&a=thuongphat"><i class="fa fa-circle-o"></i> Thưởng phạt</a></li>
